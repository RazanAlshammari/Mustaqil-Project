...
#  المرحلة الأولى، حمولة TLV تحوي الحقول الخمسة الإلزامية.
# ═══════════════════════════════════════════════════════════════
VAT_RATE = 0.15
...
def zatca_tlv_payload(seller_name, vat_number, timestamp_iso, total_incl_vat, vat_amount):
    ...
    هذه هي الصيغة القياسية في نظام فوترة معتمد: بيانات مرمَّزة
...
with tab_invoice:
    ...
    st.caption("فاتورة ضريبية مبسّطة مبنية على ترميز TLV القياسي المعتمد في فوترة "
